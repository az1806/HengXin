  ...
  <body>
    <div class="header-top">
        <div class="width-center">
            <div class="header-logo "><img src="images/logo1.png" alt=""></div>
      ...
      <div class="header-nav">
        ...
        <ul class="header-nav-ul am-collapse am-in">
            <li class="on"><a href="/HengXin/index" name="index">首页</a></li>
            <li><a href="/HengXin/about" name="about">关于我们</a></li>
            <li><a href="/HengXin/goodstype" name="show">产品展示</a></li>
            <li><a href="/HengXin/newstype" name="new">新闻资讯</a></li>
            <li><a href="/HengXin/contact" name="message">联系我们</a>
                <div class="secondary-menu">

                    <ul><li><a href="/HengXin/message" class="message"></a></li></ul>
                </div>
            </li>
        </ul>

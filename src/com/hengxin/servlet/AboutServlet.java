...
import com.dao.impl.AboutDaoImpl;
...
public class AboutServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("½øÈë AboutServlet");
		GeneralDao comDao = new GeneralDaoImpl();
		General com = comDao.queryGeneral();
		request.setAttribute("General", com);
		
		AboutDao ptd = new AboutDaoImpl();
		List<Maker> mk= ptd.queryMaker();
		request.setAttribute("mzj", mk);

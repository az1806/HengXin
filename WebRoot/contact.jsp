...
<div>
    ...
    <main class="contact">
        <span src="map.html" width="636" height="378" frameborder="0" scrolling="no" style="width:660px;height:378px;border:#ccc solid 1px;" id="dituContent"> </span>
        <ul>
...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(114.38567,36.042304);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"公司地址",content:"我的备注",point:"114.38602|36.043136",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
